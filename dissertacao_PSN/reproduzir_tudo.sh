...
export BIOMA_ATIVO=TODOS RODAR_EM_PARALELO=0 TESTAR_GRAUS=1 RODAR_YRANDOMIZATION=1 GRAU_MODELO=2
python3 Modelo_PSN.py            | tee resultados_2001_2025/log_modelo_psn_completo.txt   # modelo, VIF, resíduos, Y-rand, graus 1-5
